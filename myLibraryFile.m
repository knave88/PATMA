...
%This function was generated by loadlibrary.m parser version  on Tue Jul 20 12:49:28 2021
%perl options:'openslide-wrapper.i -outfile=myLibraryFile.m -thunkfile=libopenslide_thunk_pcwin64.c -header=openslide-wrapper.h openslide.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'libopenslide_thunk_pcwin64');
